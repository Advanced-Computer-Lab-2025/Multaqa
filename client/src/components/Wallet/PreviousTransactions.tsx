...
const PreviousTransactions = ({ transactions, error }: TransactionsProps) => {
    ...
    <>
      ...
      {error ? (
        ...
        <EmptyState
          ...
          description="There are no transactions in your wallet yet. Make a payment to add transactions!"
        />
      ) : (
        /* Transactions List */
