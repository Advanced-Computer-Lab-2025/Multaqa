...
const CreateWorkshop: React.FC<CreateWorkshopProps> = ({ professors, creatingProfessor, open, onClose, setRefresh }) => {
    ...
    return (
        <CustomModalLayout open={open} borderColor={accentColor} title="Create Workshop" onClose={handleClose} width="w-[95vw] xs:w-[80vw] lg:w-[70vw] xl:w-[70vw]">
            <Box sx={{
                background: '#fff',
                borderRadius: '32px',
                p: 3,
