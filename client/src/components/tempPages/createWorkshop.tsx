      ...
      <NeumorphicBox containerType="outwards" padding="20px" borderRadius="16px" margin="0 0 0px 0">
        ...
        <Accordion sx={{ mb: 0 }}>
          <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="people-content" id="people-header">
            <Typography variant="h6" fontWeight={600}>Organisers</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Grid container spacing={2}>
              <Grid size={{ xs: 12, md: 6 }}>
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                <Box sx={{ display: 'flex', gap: 1 }}>
                  <TextField  label="Professors Participating" value={profInput} onChange={e => setProfInput(e.target.value)} size="small" fullWidth />
        ...
        <Accordion  sx={{ mb: 0 }}>
          ...
          <AccordionDetails>
            <Grid container spacing={2}>
              ...
              <Grid size={{ xs: 12, md: 4 }}>
                <FormControl fullWidth>
                  <InputLabel id="funding-source-label">Funding Source</InputLabel>
                  <Select
                    labelId="funding-source-label"
                    value={fundingSource}
                    label="Funding Source"
                    onChange={(e) => setFundingSource(e.target.value as 'External' | 'GUC')}
                  >
        ...
        <Accordion  sx={{ mb: 0 }}>
          ...
          <AccordionDetails>
              <TextField label="Full Agenda" value={extraResources} onChange={e => setExtraResources(e.target.value)} multiline rows={2} fullWidth />
          </AccordionDetails>
        </Accordion>
