...
const validationSchema = yup.object({
    eventName: yup.string().required('Conference Name is required').min(3, 'Name must be at least 3 characters').max(300, 'Name can be at most 300 characters'),
    ...
    fullAgenda: yup.string().required('Agenda is required'),
});
